...
const getTransporter = () => {
    ...
    if (!host || !port || !user || !pass) {
        console.warn("⚠️ Missing SMTP credentials — using console transport. Emails won't actually send.");
...
export const sendContactEmail = async (payload) => {
    ...
    const mailFrom = payload.html?.includes("Email:") && payload.text.match(/Email:\s*(.*)/)
